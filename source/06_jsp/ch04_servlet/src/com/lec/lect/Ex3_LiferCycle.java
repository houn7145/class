...
public class Ex3_LiferCycle extends HttpServlet {
	...
	public void destroy() {
		// 서블릿 객체가 소멸될 때 실행
		System.out.println("Ex3_LifeCycle 서블릿 객체가 소멸(메모리에서 delete)될 때 수행 - 1");
	}
	@PreDestroy
	 ...
	 * response) throws ServletException, IOException { // service를 override하면
	 * doGet()함수와 doPost()함수가 실행되지 않고 service()함수 실행
