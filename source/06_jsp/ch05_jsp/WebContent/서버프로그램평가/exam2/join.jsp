	...
	<div id="joinForm_wrap">
		...
		<form action="joinPro.jsp" method="post">
			...
			<table>
				...
				<tr>
					<th>취미</th>
					<td><input type="checkbox" name="hobby" value="독서"
						id="readind"><label for="readind">독서</label> <input
						type="checkbox" name="hobby" value="요리" id="cooking"><label
						for="cooking">요리</label> <input type="checkbox" name="hobby"
						value="운동" id="exercise"><label for="exercise">운동</label>
						<input type="checkbox" name="hobby" value="취침" id="sleep"><label
						for="sleep">취침</label></td>
				</tr>
				<tr>
					<th>성별</th>
				...
				<tr>
					<td colspan="2"><input type="submit" value="가입하기"
						...
						class="joinBtn_style"> <input type="button" value="뒤로가기"
						class="joinBtn_style" onclick="history.back();"></td>
				</tr>
			</table>
		</form>
	</div>
