...
<body>
	...
	<%
		...
		try{
			...
			rs   = stmt.executeQuery(sql); // 4단계 (SQL문 전송) + 5단계(SQL문 결과받기)
			if(rs.next()){ // 데이터가 있는 경우
				...
				do{
					...
					out.println("<tr><th>" + empno + "</th><th>" + ename + "</th><th>" + job + "</th><th>" + mgr + "</th>" +
							"<th>" + hiredate +  "</th><th>" + hiredateD +  "</th><th>" + hiredateT + "</th><th>"+ sal + "</th><th>" + comm + "</th><th>" + deptno + "</th></tr>");
				}while(rs.next());
			}else{ // 데이터가 없는 경우
