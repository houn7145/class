...
<body>
	<%
		...
		try{ 
			...
			name = multiRequest.getParameter("name"); // multiRequest에 위임했기에 request는 전부 날라감
			// Dao의 함수를 호출하여 DB 저장
		}catch(IOException e){
			...
			if(file != null){
				...
				try{
					...
					if(serverFile.exists()){ // file이 존재하면 복사
						...
						os = new FileOutputStream("C:/houn/source/06_jsp/ch14_fileUp/WebContent/fileUpFolder/" + file);
