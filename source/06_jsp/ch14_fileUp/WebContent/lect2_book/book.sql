...
CREATE TABLE BOOK(
    BOOK_ID VARCHAR2(30) PRIMARY KEY, -- 890A-117ㄱ
    ...
    BOOK_IMAGE1 VARCHAR2(100) DEFAULT 'noImg.png' NOT NULL,
    BOOK_IMAGE2 VARCHAR2(100) DEFAULT 'NOTHING.png' NOT NULL,
