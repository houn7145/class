...
<body>
		...
		for(String imgfile : images){
			...
			if(serverFile.exists()){
				try{
					...
					os = new FileOutputStream("C:/houn/source/06_jsp/ch14_fileUp/WebContent/bookImg/" + imgfile);
	...
	<hr>
	<a href="ex1_list_board.jsp">책 전체 리스트(게시판 스타일)</a><br>
	<a href="ex2_list.jsp">1page 리스트(게시판 스타일)</a><br>
	<a href="ex3_list_product.jsp">책 전체 리스트(product list 스타일)</a><br>
