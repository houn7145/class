...
<body>
	<h1>표현식 태그 이용</h1>
	<p>산술연산자 : 10+1 = <%=10+1 %></p>
	<p>산술연산자 : 10/0.0 = <%=10/0.0 %></p><!-- 0으로 나누면 에러 | 0.0으로 나눠야 가능 -->
	<p>관계연산자 : 1>2 = <%=1>2 %></p>
	<p>관계연산자 : 1==2 = <%=1==2 %></p>
	<p>관계연산자 : 1!=2 = <%=1!=2 %></p>
	<p>조건연산자 : <%=(1>2) ? "1이 2보다 큽니다" : "1이 2보다 작습니다"%><p>
	...
	<%-- <p>su 파라미터 값 : <%=request.getParameter("su").toUpperCase() %></p> --%>
	...
	<p>su 파라미터 값 : ${param.su }</p>
	<p>su 파라미터의 대문자 변경 : ${param.su.toUpperCase() }</p>
</body>
</html>