...
<body>
	<form action="${conPath }/join.do" method="post" enctype="multipart/form-data">
		<table>
			<tr>	
				<th>아이디</th><td><input type="text" name="mid" required="required" autofocus="autofocus"></td>
			</tr>
			<tr>
			...
			<tr>
				<th>메일</th><td><input type="text" name="memail"></td>
			</tr>
			<tr>
				<th>사진</th><td><input type="file" name="mphoto"></td>
			</tr>
			<tr>
				<th>생년월일</th><td><input type="date" name="mbirth"></td>
			</tr>
			<tr>
