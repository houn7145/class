...
//	@Around("aroundM")
	...
	public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			long endTime = System.currentTimeMillis(); // 핵심기능 수헹후 밀리세컨
	...
	public void afterReturningAdvice() {
		System.out.println("핵심기능을 에러없이 수행 후 afterReturningAdvice() 자동 수행");
	}
	
	// afterThrowing advice : 핵심기능에 예외가 발생 후 공통기능 수행
	@AfterThrowing("execution(void com.lec.ch06.ex2.Worker2.get*())")
	public void afterThrowingAdvice() {
		System.out.println("핵심기능에 예외가 발생 후 afterThrowingAdvice() 자동 수행");
	}
}
